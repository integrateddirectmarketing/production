...
jQuery(document).ready(function($){
		...
		if (!document.getElementById('lbx_cookie')){
			...
			lbxCookie.src = 'https://cdn.jsdelivr.net/gh/integrateddirectmarketing/production@latest/idm/sticky_overlay/js/cookie.js';
		}
		...
		if (!document.getElementById('lbx_validate')){
			...
			lbxValidate.src = 'https://cdn.jsdelivr.net/gh/integrateddirectmarketing/production@latest/idm/sticky_overlay/js/validate.js';
		}
